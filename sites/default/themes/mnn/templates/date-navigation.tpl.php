...
<div class="date-nav clear-block">
  <div class="date-prev">
    <?php if (!empty($prev_url)) : ?>
      <span class="next"> <?php print l(($block ? '<' : '<span>'.t('Previous').'</span>'), $prev_url, $prev_options); ?></span>
    <?php endif; ?>
  &nbsp;</div>
  ...
  <div class="date-next">&nbsp;
    <?php if (!empty($next_url)) : ?>
      <span class="next"> <?php print l(($block ? '>' : '<span>'.t('Next')).'</span>', $next_url, $next_options); ?></span>
    <?php endif; ?>
  </div>
</div>
